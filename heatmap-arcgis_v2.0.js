/**
 * 在heatmap-arcgis.js的基础上修改以支持heatmap_v2.0.js\
 * @update rongc
 * @date 2015/08/21
 * @description 该类原理是通过一个跟地图窗口一样大小的隐藏div作为heatmap绘制容器，绘制完heatmap后获取canvas图形，
 *              将该图形作为DynamicMapServiceLayer的getImageUrl方法结果传递给callback，达到热点图层的效果。
 */
dojo.addOnLoad(function () {
	...
	*/
        ...
        constructor: function (properties) {
            ...
            //设置最大值
            this.max = this.properties.max == undefined?this.max:this.properties.max;
            // last data storage
            this.lastData = [];
            // map node
            ...
            this.config = {
                ...
                radius: 40,
                gradient: {
                    0.45: "rgb(000,000,255,0.2)",
                    0.55: "rgb(000,255,255,0.4)",
                    0.65: "rgb(000,255,000,0.7)",
                    0.95: "rgb(255,255,000,0.7)",
                    1.00: "rgb(255,255,000,0.7)"
                }
            };
